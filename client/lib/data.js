...
export const portfolioItems = [
  {
    ...
    description:
      "A professional job portal connecting employers and job seekers with a seamless application process.",
    category: "Web Development",
    image:
    ...
    budget: "₹ XXXXXX",
    results: [
      "100+ job listings posted",
      "Automated hiring workflow",
      "Dynamic candidate dashboard",
    ],
    challenge:
      "Creating a real-time job posting and filtering system for multiple employers.",
    solution:
      "Developed a role-based system with dynamic filtering and instant job updates.",
  },
  {
    id: "2",
    title: "Digital Health – AI Healthcare Platform",
    description:
      "Smart digital healthcare system for online doctor consultations and health monitoring.",
    ...
    solution:
      "Integrated OpenAI API with a custom symptom-checker and real-time booking system.",
  },
  {
    id: "3",
    title: "Developous – Tech Solutions Agency",
    description:
      "Official website of Developous offering web, mobile, AI, and cloud services worldwide.",
    ...
    challenge:
      "Creating a high-performance agency website with SEO and modern design.",
    solution:
      "Developed using Next.js 14 with optimized metadata, sitemap, and OpenGraph tags.",
  },
  {
    id: "4",
    title: "BlogSave – Modern Blogging Platform",
    description:
      "A user-friendly blogging platform for writers to post, edit, and share blogs with readers worldwide.",
    category: "Web App",
    image:
    ...
    solution:
      "Integrated Firebase Auth and Firestore for seamless CRUD and authentication.",
  },
  {
    id: "5",
    title: "Gym MiraRoad – Fitness Website",
    description:
      "A dynamic website for a fitness center showcasing membership plans, trainers, and workout schedules.",
    ...
    challenge:
      "Building an attractive landing page with lead form integration.",
    solution:
      "Implemented EmailJS for contact forms and optimized responsive design.",
  },
  {
    id: "6",
    title: "CarsDoctor – Car Service Booking App",
    description:
      "Online platform for car service and maintenance booking with real-time tracking.",
    ...
    solution:
      "Created customer, admin, and mechanic dashboards with real-time updates.",
  },
  {
    id: "7",
    title: "Akruti Developers – Real Estate Website",
    description:
      "Real estate showcase website featuring projects, locations, and client inquiries.",
    ...
    solution:
      "Integrated location maps, project details, and inquiry forms with modern UI.",
  },
  {
    id: "8",
    title: "Music Distribution Platform (MDP)",
    description:
      "An online platform for artists to upload, manage, and distribute their music across platforms.",
    category: "Web App",
    image:
    ...
    budget: "₹ XXXXXX",
    results: [
      "Automated music uploads",
      "Secure artist accounts",
      "Responsive dashboard",
    ],
    challenge: "Handling secure media uploads and user authentication.",
    solution:
      "Used Firebase Storage with authentication and dynamic dashboard UI.",
  },
  {
    id: "9",
    title: "Book Finder App",
    description:
      "Smart book search and recommendation platform using the Google Books API.",
    category: "Web App",
    image:
    ...
    results: [
      "Instant book search",
      "Detailed book info",
      "Clean UI for readers",
    ],
    challenge: "Fetching large datasets from the Google Books API efficiently.",
    solution:
      "Implemented optimized API fetching with search debouncing and pagination.",
  },
  {
    id: "10",
    title: "Food Delivery Website",
    description:
      "Modern food delivery website for restaurants with dynamic menu and cart system.",
    category: "E-commerce",
    image:
    ...
    solution:
      "Developed responsive UI with Redux for cart and order management.",
  },
  {
    id: "11",
    title: "Smart AI Bot",
    description:
      "AI chatbot web app for intelligent conversations and task assistance.",
  ...
  },
  {
    ...
    description:
      "AI-powered weather assistant providing live weather updates and forecasts.",
    ...
    solution:
      "Integrated OpenAI and Weather APIs with live, conversational weather updates.",
  },
];
...
export const testimonials = [
  {
    ...
    position: "CEO",
    testimonial:
      "FreelanceTeam delivered an exceptional e-commerce platform that exceeded our expectations. Their attention to detail and professional approach made all the difference. We saw a 300% increase in sales within the first quarter.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    position: "CTO",
    testimonial:
      "The mobile app they developed for us has been a game-changer for our business. The user experience is fantastic and the performance is outstanding. We've achieved 50,000+ downloads and 4.8/5 rating.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    testimonial:
      "Their AI solution helped us automate our customer service and improve response times by 80%. The implementation was smooth and the results were immediate. Highly recommend their expertise.",
    rating: 5,
    avatar:
...
export const guarantees = [
  {
    ...
    description:
      "If you're not completely satisfied, we'll revise until you are.",
    icon: "🎯",
  },
  {
    title: "On-Time Delivery",
    description:
      "We guarantee to deliver your project on schedule or it's free.",
    icon: "⏰",
  },
  {
...
export const blogPosts = [
  {
    ...
    excerpt:
      "Discover how AI, Next.js, and automation are redefining the future of web development in 2025.",
    content:
