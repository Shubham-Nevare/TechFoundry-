...
export default function Services() {
  ...
  const process = [
    ...
    },
    {
      ...
      description:
        "Our team creates wireframes, mockups, and technical architecture for your project.",
      icon: Palette,
      duration: "1-3 weeks",
    },
    {
        ...
        <div className="max-w-7xl mx-auto mobile-px">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="mobile-text-lg text-gray-600 max-w-2xl mx-auto">
              We deliver exceptional results with proven expertise and
              reliability
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 mobile-gap">
                ...
                >
                  <CardHeader className="p-4 sm:p-6">
                    <div className="flex items-start gap-3 sm:gap-4">
                      {/* Icon */}
                      <div className="w-12 h-12 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div className="flex flex-col">
                        ...
                        <CardDescription className="text-base sm:text-lg text-gray-600 dark:text-gray-400 mt-1">
                          {service.description}
                        </CardDescription>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="space-y-4 sm:space-y-6">
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2 sm:mb-3 mobile-text-sm">
                          What's Included:
                        </h4>
                        <ul className="space-y-1 sm:space-y-2">
                          {service.includes.map((item, index) => (
                            <li
                              key={index}
                              className="flex items-center mobile-text-sm text-gray-600"
                            >
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        <div className="flex items-center justify-between mobile-text-xs">
                          ...
                          <span className="font-bold text-blue-600 mobile-text-base">
                      ...
                      <div className="pt-3 sm:pt-4 border-t">
                        <h4 className="font-semibold text-gray-900 mb-2 mobile-text-sm">
                          Key Features:
                        </h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600">
                Accurate delivery timelines for every project
              </p>
            </Card>
            <Card className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600">
                Guaranteed quality with revision cycles included
              </p>
            </Card>
          </div>
        </div>
