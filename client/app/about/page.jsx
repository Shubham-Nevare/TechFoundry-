...
export default function About() {
  ...
  const values = [
    ...
    },
    {
      title: "Reliability",
      description:
        "Count on us to deliver on time and exceed your expectations every time.",
      icon: Shield,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div ref={storyRef}>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2025, Developous started as a vision to bridge the
                gap between innovative technology and business needs. We saw too
                many companies struggling with unreliable freelancers and
                impersonal agencies.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our solution was simple: create a dedicated team of experts who
                work together seamlessly, providing the reliability of an
                in-house team with the flexibility and cost-effectiveness of
                freelancing.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Let's discuss your project and see how our team can help you
            succeed.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-purple-600 bg-white hover:bg-gray-50"
            >
              Start Your Project
            </a>
            <a
              href="/portfolio"
              className="inline-flex items-center justify-center px-8 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-white hover:text-purple-600"
            >
              View Our Work
            </a>
          </div>
